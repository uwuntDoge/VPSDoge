...
function_verify () {
  ...
  echo -e "\n\n\n\033[1;95m======================================================\n ¡ESTA KEY NO CONCUERDA CON EL INSTALADOR!,CONTACTE A @conectedmx\n======================================================\n"
  [[ -d /etc/newadm ]] && rm -rf /etc/newadm
    [[ -d /etc/ger-frm ]] && rm -rf /etc/ger-frm
      [[ -d /etc/ger-inst ]] && rm -rf /etc/ger-inst
  exit 1
  } || {
...
if [[ -e $HOME/lista-arq ]] && [[ ! ]]; then
   msg -bar2
   msg -verd " INSTALANDO: \033[1;31m[VPS-MX #MOD by @Kalix1]"
